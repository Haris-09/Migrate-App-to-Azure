...
def main(msg: func.ServiceBusMessage):
    ...
    try:
        ...
        db_conn = psycopg2.connect(host="techconf-postgres-db-server.postgres.database.azure.com", database="techconfdb", user="postgresAdmin@techconf-postgres-db-server", password="p0stGp@55word")
